...
const version = "1.1.16"; //Update for every build and publish
...
export default {
  ...
  slug: getSlug(),
  version: version,
  runtimeVersion: "1.16", //All apps using the same runtime will get the published updates. Generally update for every new build
