...
const version = "1.2.99"; //Update for every build and publish

export default {
  name: getAppName(),
  slug: getSlug(),
  version: version,
  runtimeVersion: "2.98", //All apps using the same runtime will get the published updates. Generally update for every new build
