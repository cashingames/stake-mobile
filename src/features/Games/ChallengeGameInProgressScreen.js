...
import {
    ...
    pauseGame, skipQuestion, boostReleased, bombOptions, setHasPlayedTrivia, challengeEndGame
} from "./GameSlice";
...
export default function ChallengeGameInProgressScreen({ navigation, route }) {
