  ...
  const handleTourStop = ()=>{
    ...
    return (
      <View style={styles.container}>
        ...
        <CopilotStep text={
                      <View>
                          <Text style={styles.tourTitle} >Leaderboard</Text>
                          <Text style={styles.tourDesc}>
                            View your position on the weekly leaderboard and continue to play more games to move up the leaderboard
                          </Text>
                      </View>
        ...
        <Image style={{ flex: 1, width: '100%' }} source={require("../../../../assets/images/monthly_leaderboard.png")} />
      </View>
    )
}
